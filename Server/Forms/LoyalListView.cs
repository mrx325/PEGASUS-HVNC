...
internal class LoyalListView : Control
{
	...
	private List<LoyalListViewItem> _selectedItems = new List<LoyalListViewItem>();
	...
	public void AddItem(string text, string[] subitems)
	{
		...
		{
			LoyalListViewSubItem item = new LoyalListViewSubItem(text2);
			list.Add(item);
		}
